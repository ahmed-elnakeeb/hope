...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon("D:\hope\mypyqt\icon.ico"))
        ...
        self.PushButton1.setText("click me")
        ...
        self.PushButton1.clicked.connect(lambda: self.clicked("pushed"))
